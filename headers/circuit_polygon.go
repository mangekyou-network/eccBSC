...
func (c *PolygonCircuit) Define(api frontend.API) error {
	c.api = api
...
func (c *PolygonCircuit) computeBlockHashes() [][256]frontend.Variable {
...
func (c *PolygonCircuit) checkMerkleRoot(blockHashes [][256]frontend.Variable) {
...
func (c *PolygonCircuit) checkBoundary(prevHash [256]frontend.Variable) {
...
func (c *PolygonCircuit) checkConnectivity(blockHashes [][256]frontend.Variable, parentHashes [][256]frontend.Variable) {
...
func (c *PolygonCircuit) decodeParentHashes() [][256]frontend.Variable {
...
func (c *PolygonCircuit) decodeParentHash(header []frontend.Variable) [256]frontend.Variable {
...
func (c *PolygonCircuit) decodeBlockNumber(hBits []frontend.Variable) frontend.Variable {
...
func (c *PolygonCircuit) bits2Nibs(bits []frontend.Variable) []frontend.Variable {
	if len(bits)%8 != 0 {
...
func (c *PolygonCircuit) byte2Nibs(bits []frontend.Variable) []frontend.Variable {
	if len(bits) != 8 {
		panic("bit len not 8")
	}
